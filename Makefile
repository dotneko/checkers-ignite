...
install-protoc-gen-ts:
	...
	cd client/scripts/protoc && unzip -o protoc.zip
	rm client/scripts/protoc/protoc.zip
	ln -s $(pwd)/client/scripts/protoc/bin/protoc /usr/local/bin/protoc
