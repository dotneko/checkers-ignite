...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/dotneko/checkers/checkers/can_play_move/{gameIndex}/{player}/{fromX}/{fromY}/{toX}/{toY}
   */
  queryCanPlayMove = (
    gameIndex: string,
    player: string,
    ...
    this.request<CheckersQueryCanPlayMoveResponse, RpcStatus>({
      path: `/dotneko/checkers/checkers/can_play_move/${gameIndex}/${player}/${fromX}/${fromY}/${toX}/${toY}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/dotneko/checkers/checkers/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<CheckersQueryParamsResponse, RpcStatus>({
      path: `/dotneko/checkers/checkers/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/dotneko/checkers/checkers/stored_game
   */
  queryStoredGameAll = (
    query?: {
    ...
    this.request<CheckersQueryAllStoredGameResponse, RpcStatus>({
      path: `/dotneko/checkers/checkers/stored_game`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
