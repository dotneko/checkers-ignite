...
import DotnekoCheckersDotnekoCheckersCheckers from './dotneko/checkers/dotneko.checkers.checkers'
...
export default { 
  ...
  DotnekoCheckersDotnekoCheckersCheckers: load(DotnekoCheckersDotnekoCheckersCheckers, 'dotneko.checkers.checkers'),
